...
class Controller():
    ...
    def __init__(self, _model: ModelBasic):
        self.model = _model
    ...
    def execution(self):
        ...
        """
        _floor_x_pos = self.model.get_value('floor_x_pos')
        _man_y_pos = self.model.get_value('man_y_pos')
        _running = self.model.get_value('running')
        _man_movement = self.model.get_value('man_movement')
        _pipe_list = self.model.get_value('pipe_list')
        _pip_surface = self.model.get_value('pip_surface')
        _game_active = self.model.get_value('game_active')
        _man_index = self.model.get_value('man_index')
        _man_run = self.model.get_value('man_run')
        _score = self.model.get_value('score')
        _high_score = self.model.get_value('high_score')
        _man_run_list = self.model.get_value('man_run_list')
        _score_sound_count_down = self.model.get_value('score_sound_count_down')
        ...
        self.model.set_value('floor_x_pos', _floor_x_pos)
        self.model.set_value('man_y_pos', _man_y_pos)
        self.model.set_value('running', _running)
        self.model.set_value('man_movement', _man_movement)
        self.model.set_value('pipe_list', _pipe_list)
        self.model.set_value('pip_surface', _pip_surface)
        self.model.set_value('game_active', _game_active)
        self.model.set_value('man_index', _man_index)
        self.model.set_value('man_run', _man_run)
        self.model.set_value('score', _score)
        self.model.set_value('high_score', _high_score)
        self.model.set_value('man_run_list', _man_run_list)
        self.model.set_value('score_sound_count_down', _score_sound_count_down)
        return self.model
...
while True:  # Main loop
    ...
    running = model.get_value('running')
